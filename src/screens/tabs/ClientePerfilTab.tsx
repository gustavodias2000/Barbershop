...
const getStyles = (theme: Theme) => StyleSheet.create({
  ...
  badgeText: { fontSize: 13, color: theme.colors.primary, fontWeight: '600' },
  sectionLabel: {
    fontSize: 11,
    fontWeight: '700',
  ...
  itemLabel: { flex: 1, fontSize: 15, color: theme.colors.text, fontWeight: '500' },
  chevron: { fontSize: 22, color: theme.colors.textMuted },
  checkmark: { fontSize: 18, color: theme.colors.primary, fontWeight: '700' },
  logoutButton: {
    marginTop: 28,
